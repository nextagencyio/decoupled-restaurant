...
export const metadata: Metadata = {
  title: 'Events | Ember & Bloom',
  description: 'Discover upcoming events, live music nights, and special dining experiences at Ember & Bloom.',
}
      ...
      <section className="relative bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-accent-400 font-display text-sm tracking-widest uppercase mb-4">What&apos;s Happening</p>
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Events
            </h1>
            <p className="text-xl text-primary-200 max-w-3xl mx-auto">
              Live music, wine tastings, seasonal celebrations, and unforgettable evenings.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="font-display text-2xl font-bold text-gray-700 mb-2">No Events Yet</h2>
